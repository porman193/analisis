    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <?php
                        $operario=$operariodao->consultar_usuario($_SESSION['id']);
                    ?>
                    <div class="container-fluid px-4">
                            <h1 class="breadcrumb-item active text-center">Bienvenid@ <?php echo $operario['nombre']." ".$operario['apellido'];?></h1>
                            ...
                            <div class="col-md-10" id="cards-izq">
                             ...
                             <div class="col-md-2" id="cards-der">
                                ...
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Asignación de plazas</div>
                                    <img src="" alt="">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="CrudFront/Plazas">Ir</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Registro de vehiculos</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="CrudFront/Registro/registro_vehiculos.php">Ir</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    <img src="" alt="">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="CrudFront/Facturacion/facturacion.php">Ir</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>

                                <div class="card bg-secondary text-white mb-4">
                                    <div class="card-body">Opción 4</div>
                                    <img src="" alt="">
                                    <div class="card-footer d-flex align-items-center justify-content-between">
