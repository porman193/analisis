            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Información de Plazas Asignadas</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/home/parqueadero/Home_Operario.php">Home</a></li>
                            <li class="breadcrumb-item active">Plazas Asignadas</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $registros[$i]['id_plaza']?></td>
                                                        <td><?php echo $registros[$i]['placa']?></td>
                                                        <td><?php echo $registros[$i]['id_cliente']?></td>
                                                    </tr>
                                                <?php
                                                    }
                                                ?>
